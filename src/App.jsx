...
function App() {
  const [markdown, setMarkdown] = useState(demoText);
  ...
  return (
    <div className="flex lg:flex-row flex-col gap-4 bg-[#0d1117] text-[#f0f6fc] w-screen h-screen p-2 transition-all duration-300">
      <div
        id="textarea-outer"
        className={`flex flex-col transition-all duration-300 bg-[#151b23] border rounded-md ${
      ...
      <div
        id="preview"
        className={`flex flex-col transition-all duration-300 bg-[#151b23] overflow-auto border rounded-md ${
